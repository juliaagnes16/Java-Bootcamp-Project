...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        System.out.print("\nEnter a greeting: ");
        scanner.nextLine(); //this code function is to throwaway nextline to be wasted on empty space
        String greeting = scanner.nextLine(); //nextLine after nextInt will wasted by getting empty space from above, so the solution to add nextLine above this code.
